...
import { X, Upload, Image as ImageIcon, File, Loader2, Search, Trash2, Eye } from "lucide-react";
                    ...
                    <div className="flex-1 overflow-y-auto p-4">
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-48 text-center">
                                ...
                                <p className="text-[14px] font-semibold text-[#0D1117] mb-1">No images found</p>
                                <p className="text-[12px] text-[#8A9BB0]">Upload your first image to get started</p>
                            </div>
                        )}
                    </div>
