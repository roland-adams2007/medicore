  ...
  return (
    <>
      ...
      >
        ...
        >
          <Link to={isSuperAdmin ? "/admin" : "/dashboard"} className="flex items-center gap-2.5 no-underline" onClick={onClose}>
            <div
            ...
            <div key={section.label} className="mb-1">
              ...
              {section.items.map((item) => (
                <NavItem
                  ...
                  badge={item.badge}
                  dot={item.dot}
                  to={ROUTE_MAP[item.key] ?? (isSuperAdmin ? "/admin" : "/dashboard")}
